...
class ForecastScraper:
    ...
    def parse_forecast_text(self, text: str, zone: str) -> MarineForecast:
        ...
        return MarineForecast(
            zone=zone.upper(), name=zone_name, issued=issued, expires=expires, periods=periods
        )
    ...
    def _extract_periods(self, text: str) -> list[ForecastPeriod]:
        ...
        for period_name, period_text in matches:
            ...
            for sentence in sentences:
                ...
                has_weather_pattern = any(
                    re.search(pattern, sentence, re.IGNORECASE) for pattern in weather_patterns
                )
            ...
            periods.append(
                ForecastPeriod(name=period_name, wind=wind, waves=waves, weather=weather)
            )
